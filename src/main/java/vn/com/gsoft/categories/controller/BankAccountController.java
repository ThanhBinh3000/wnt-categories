...
public class BankAccountController {
    ...
    public ResponseEntity<BaseResponse> colection(@RequestBody BankAccountReq objReq) throws Exception {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<BaseResponse> colectionList(@RequestBody BankAccountReq objReq) throws Exception {
    ...
    public ResponseEntity<BaseResponse> insert(@Valid @RequestBody BankAccountReq objReq) throws Exception {
    ...
    @ResponseStatus(HttpStatus.CREATED)
    public ResponseEntity<BaseResponse> update(@Valid @RequestBody BankAccountReq objReq) throws Exception {
    ...
    @ResponseStatus(HttpStatus.OK)
    public ResponseEntity<BaseResponse> delete(@Valid @RequestBody BankAccountReq idSearchReq) throws Exception {
