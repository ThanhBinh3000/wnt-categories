...
public class AreaProvinceController {
  ...
  @Autowired
  AreaProvinceService service;


  @PostMapping(value = PathContains.URL_SEARCH_PAGE, produces = MediaType.APPLICATION_JSON_VALUE)
  @ResponseStatus(HttpStatus.OK)
  public ResponseEntity<BaseResponse> colection(@RequestBody AreaProvinceReq objReq) throws Exception {
  ...
  @ResponseStatus(HttpStatus.OK)
  public ResponseEntity<BaseResponse> colectionList(@RequestBody AreaProvinceReq objReq) throws Exception {
  ...
  public ResponseEntity<BaseResponse> insert(@Valid @RequestBody AreaProvinceReq objReq) throws Exception {
  ...
  @ResponseStatus(HttpStatus.CREATED)
  public ResponseEntity<BaseResponse> update(@Valid @RequestBody AreaProvinceReq objReq) throws Exception {
  ...
  @ResponseStatus(HttpStatus.OK)
  public ResponseEntity<BaseResponse> delete(@Valid @RequestBody AreaProvinceReq idSearchReq) throws Exception {
