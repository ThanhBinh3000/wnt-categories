...
@Slf4j
@RestController
@RequestMapping("/trien-khai")
public class TrienKhaisController {
	
  @Autowired
  TrienKhaisService service;


  @PostMapping(value = PathContains.URL_SEARCH_PAGE, produces = MediaType.APPLICATION_JSON_VALUE)
  @ResponseStatus(HttpStatus.OK)
  public ResponseEntity<BaseResponse> colection(@RequestBody TrienKhaisReq objReq) throws Exception {
  ...
  @ResponseStatus(HttpStatus.OK)
  public ResponseEntity<BaseResponse> colectionList(@RequestBody TrienKhaisReq objReq) throws Exception {
  ...
  public ResponseEntity<BaseResponse> insert(@Valid @RequestBody TrienKhaisReq objReq) throws Exception {
  ...
  @ResponseStatus(HttpStatus.CREATED)
  public ResponseEntity<BaseResponse> update(@Valid @RequestBody TrienKhaisReq objReq) throws Exception {
  ...
  @ResponseStatus(HttpStatus.OK)
  public ResponseEntity<BaseResponse> delete(@Valid @RequestBody TrienKhaisReq idSearchReq) throws Exception {
