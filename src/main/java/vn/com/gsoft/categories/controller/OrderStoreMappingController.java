...
@Slf4j
@RestController
@RequestMapping("/order-store-mapping")
public class OrderStoreMappingController {
	
  @Autowired
  OrderStoreMappingService service;


  @PostMapping(value = PathContains.URL_SEARCH_PAGE, produces = MediaType.APPLICATION_JSON_VALUE)
  @ResponseStatus(HttpStatus.OK)
  public ResponseEntity<BaseResponse> colection(@RequestBody OrderStoreMappingReq objReq) throws Exception {
  ...
  @ResponseStatus(HttpStatus.OK)
  public ResponseEntity<BaseResponse> colectionList(@RequestBody OrderStoreMappingReq objReq) throws Exception {
  ...
  public ResponseEntity<BaseResponse> insert(@Valid @RequestBody OrderStoreMappingReq objReq) throws Exception {
  ...
  @ResponseStatus(HttpStatus.CREATED)
  public ResponseEntity<BaseResponse> update(@Valid @RequestBody OrderStoreMappingReq objReq) throws Exception {
  ...
  @ResponseStatus(HttpStatus.OK)
  public ResponseEntity<BaseResponse> delete(@Valid @RequestBody OrderStoreMappingReq idSearchReq) throws Exception {
