...
import vn.com.gsoft.categories.entity.WarehouseTransition;
import vn.com.gsoft.categories.model.dto.NhomBacSiesReq;

import java.util.List;

@Repository
public interface WarehouseLocationTransitionRepository extends CrudRepository<WarehouseTransition, Long> {
